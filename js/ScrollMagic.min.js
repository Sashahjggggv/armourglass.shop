setTimeout(function(){$('body').addClass('loaded-anime');},50);
...
var controller;jQuery(function($){'use strict';controller=new ScrollMagic.Controller();var bannersParallaxL=$('.banner-parallax').length;for(var k=0;k<bannersParallaxL;k++){new ScrollMagic.Scene({triggerElement:$('.banner-parallax')[k],triggerHook:1,duration:$(window).height()+$($('.banner-parallax')[k]).height()}).setTween(new TimelineMax().fromTo($($('.banner-parallax')[k]).find('.bg-entry'),1,{scale:'1',y:'-300px'},{scale:'1.3',y:'200px',ease:Linear.easeNone})).addTo(controller);}});
